...
public class App {
	...
	public static void main(String[] args) {
		...
		stud.setStuid(1);
		stud.setStuname("MS Dhoni");
		stud.setStucity("Ranchi");
		...
		//Name wise sorting
		Collections.sort(studList,Comparator.comparing(Student::getStuname));
		System.out.println(studList);
		
		//City wise sorting 
		Collections.sort(studList,Comparator.comparing(Student::getStucity));
		System.out.println(studList);
		//Get student by id 
		try {
